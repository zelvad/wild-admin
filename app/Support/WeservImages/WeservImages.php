...
namespace Support\WeservImages;

use Illuminate\Support\Facades\App;
use Support\WeservImages\Concerns\InteractWithFitFormats;
use Support\WeservImages\Concerns\InteractWithOutputFormats;
use Support\WeservImages\Enums\Filter;

class WeservImages
{
    use InteractWithFitFormats;
    use InteractWithOutputFormats;
    ...
    public static function make(string $imageUrl, ?string $baseUrl = null): self
    {
        return new static($imageUrl, $baseUrl);
    }
